  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={logo} alt="logo" className="sm:w-[100px] sm:h-[50px] w-[70px] h-[45px] object-contain" />
        </Link>
            ...
            >
              ...
              >
                {navLinks.map((nav) => (
                  <li
                    key={nav.id}
                    className={`${active === nav.title ? "text-french" : "text-eerieBlack"}  font-bold font-arenq text-xl 
