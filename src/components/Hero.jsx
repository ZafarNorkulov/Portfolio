  ...
  return (
    <>
      <div className="absolute top-0 left-0 z-0 h-[100vh] w-screen">
        <img src={bwmap} alt="world map" className="w-full h-full md:block hidden object-cover" />
      </div>
      <div className="absolute top-0 left-0 z-0 h-[100vh] w-screen">
        <img src={worldmap} alt="world map" className="w-full h-full md:hidden block object-cover" />
      </div>
      <section
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-eerieBlack`}>
              <span className="whitespace-nowrap">I&apos;m a Frontend Developer.</span>{" "}
          ...
          <div
            ...
            justify-center md:-ml-[3rem] xxs:mt-4"
          ></div>
        ...
        >
          <a href="#about">
            <div className=" xl:w-[35px] xl:h-[64px] md:w-[30px] md:h-[56px] w-[24px] h-[44px] rounded-3xl border-4 border-french border-dim md:flex hidden justify-center items-start xl:p-2 md:p-[6px] p-[4px]">
              <motion.div
                animate={{
                  y: [0, 20, 0],
                }}
